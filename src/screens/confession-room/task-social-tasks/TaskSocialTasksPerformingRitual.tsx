...
const TaskSocialTasksPerformingRitual = () => {
  const navigation =
  ...
  if (context === 'success') {
    return (
      <RedemptionModal
        ...
        type="success"
        onConfirmAction={() => {
          navigation.navigate(Routes.CONFESSION_ROOM_TASK_SOCIAL_TASKS, {
            machineName,
            task,
          });
        }}
...
export default TaskSocialTasksPerformingRitual;
