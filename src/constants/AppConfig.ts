export const STORAGE_IMAGES_BUCKET_URL =
  'https://prayers-for-africa-dev.storage.yandexcloud.net/';
export const MAIN_ARTICLES_URL =
  'https://app.romeblogue.store/api/articles/';
